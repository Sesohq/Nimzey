...
export const perlinNoiseNode: NodeDefinition = {
  ...
  parameters: [
    { id: 'scale', label: 'Scale', type: 'float', defaultValue: 4.0, min: 0.1, max: 50, step: 0.1, mappable: true },
    { id: 'stretch', label: 'Stretch', type: 'float', defaultValue: 0, min: 0, max: 100, step: 1, unit: '%', mappable: true },
    { id: 'angle', label: 'Angle', type: 'angle', defaultValue: 0, min: 0, max: 360, step: 1, unit: '°', mappable: true },
